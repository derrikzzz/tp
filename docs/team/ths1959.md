...
## Project Overview
**TripLog** is a CLI-centric desktop application designed for travelers who prefer managing their itineraries via a terminal interface. It allows users to track destinations, dates, and costs, providing a streamlined alternative to traditional GUI-based travel planners.
